                        ...
                        <MainCard>
                            <Stack spacing={2}>
                                <Stack direction="row" spacing={1} alignItems="center">
                                    ...
                                    <IconButton color="inherit" onClick={() => handleCopy(`http://localhost:5000/summary?convID=${convID}`)}>
                                        <ContentCopyIcon />
                                    </IconButton>
                                    ...
                                    <IconButton color="inherit" onClick={() => handleCopy(`http://localhost:5000/transcript?convID=${convID}`)}>
                                        <ContentCopyIcon />
                                    </IconButton>
